...
public class BaseManager {
    ...
    /**
     * Obtiene todos los registros de una tabla en base a la definición
     * del bean correspondiente.
     *
     * @param Class
     * @param Object 
     */
...
//    }
    ...
    /**
     * Obtiene todos los registros de una tabla mapeada a un Bean, los carga en un List
     * @param clazz
     * @param sql
     ...
     * @param String
     * @return List
     * Devuelte un List de Map<String, Object>. La llave corresponde al nombre
     * de la columna en la base de datos, y el valor es el valor correspondiente
     * para esa columna para ese registro
     */
     ...
     * @param List
     * @return List
     * Devuelte un List de Map<String, Object> con parámetros. 
     * La lista de parámetros (params) debe tener los parámetros en orden
     * según la consulta SQL.
     * La llave corresponde al nombre de la columna en la base de datos, 
     * y el valor es el valor correspondiente para esa columna para ese registro. 
     */
